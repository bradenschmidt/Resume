...
\section{Education}
\cventry{2010--2015}{Bachelor of Science - Computer Science - Four Year - with Distinction}{University of Saskatchewan}{Saskatoon}{}{78\% Overall Average -- with Distinction}  % arguments 3 to 6 can be left empty
...
\cvitem{Languages}{Java, Android, SQL, Web (HTML, PHP, Javscript), C, Python}{}
\cvitem{Tools}{Android Studio, Google App Engine, Git}{}
