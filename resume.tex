...
\section{Education}
\cventry{2010--2015}{Bachelor of Science - Computer Science - Four Year - with Distinction}{\newline University of Saskatchewan}{Saskatoon}{}{77\% Major Average -- with Distinction}  % arguments 3 to 6 can be left empty
...
\cvitem{Hockey Database}{
  \begin{itemize}
    ...
    \item Database developed in PostgreSQL and converted to MySQL with a front end website built using HTML, CSS, and PHP for viewing the data and allowing administrative changes.
  \end{itemize}
}
...
\cvitem{Libraries/Frameworks}{Robospice, Retrofit, ButterKnife, Facebook API, Google Plus API, Picasso, PHP Slim, Flask}{}
